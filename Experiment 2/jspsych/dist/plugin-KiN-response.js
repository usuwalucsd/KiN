  ...
  class KiNResponse{
    ...
    trial(display_element, trial) {
      ...
      if(trial.trial == 'attention_check_asksize'){
        const jsPsych = this.jsPsych;  // save reference at the top
    
        buttons = jsPsych.randomization.repeat(["alot", "alittle"], 1)
        // buttons = ['alot', 'alittle']
        display_element.innerHTML += `
          <style>
            .imagebutton {
              width: 25vw;
        ...
        display_element.innerHTML += `
          <div style="display: flex; align-items: center; gap: 5vw;">
            ...
            <div>
              <img class="secretbutton" src="stim/more-stim/${trial.scenario}_${trial.ask_size}ask_agent${trial.agent}.png" id="secret-button" />
            </div>
